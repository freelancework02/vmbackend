...
// POST /api/events
// field for files: "images" or "images[]" (multer fields -> req.files may be object)
...
exports.createEvent = async (req, res) => {
  ...
  try {
    ...
    if (!req.files) {
      ...
      // if somehow upload.any() or single used, multer may provide array
      files = req.files;
    } else {
...
// form fields: event_id (or eventId), optional sort_order
//
...
// PUT /api/events/:id
// Accepts multipart form data (images or images[])
